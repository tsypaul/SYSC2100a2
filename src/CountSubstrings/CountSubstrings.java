...
public class CountSubstrings {
	...
	private static int getNumber(List<Character> text, List<Character> pattern){
		List<Character> l = text;
		if(findBrute(text, pattern)!=-1){
			return getNumber()
		}else if(l.size())
	}
    ...
    public static void main(String[] args) {
        ...
        s1.close();
        System.out.println("Using ArrayLists: " + getNumber(l, pattern) + " matches, derived in " + " " + (System.currentTimeMillis() - begin) + " milliseconds.");
        long begin2 = System.currentTimeMillis();
        System.out.println("Using LinkedLists: " + getNumber(l, pattern) + " matches, derived in " + " " + (System.currentTimeMillis() - begin2) + " milliseconds");
    }
}
